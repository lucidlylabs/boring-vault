...
import {LucidlyChainlinkOracleV1_1} from "src/adapters/oracle/LucidlyChainlinkOracleV1_1.sol";
import {Script, console} from "forge-std/Script.sol";
import {stdJson} from "forge-std/StdJson.sol";

// source .env && forge script script/DeployLucidlyChainlinkOracleV1_1.s.sol:DeployLucidlyChainlinkOracleV1_1Script \
//   --sig 'run(string)' syrupusdc_usdc.json --broadcast --verify

contract DeployLucidlyChainlinkOracleV1_1Script is Script {
    ...
    function run(string memory configFile) external {
        ...
        bytes memory creationCode = type(LucidlyChainlinkOracleV1_1).creationCode;
