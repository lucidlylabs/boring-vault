...
contract CreateSyUsdEthereumLeafsSafe is Script, MerkleTreeHelper {
    ...
    address public highYieldUsdcVault = 0xA762361D505E33D08D5170DfcBf8254a2d58C2B8;
    address public highYieldUsdcWithdrawQueue = 0xAaAF1586e705aD506EB3f3f547091e66064E9220;
    ...
    function _writeSafeBatch(address[] memory tos, bytes[] memory datas) internal {
        ...
        string memory batch = string.concat(
            ...
            ',"meta":{"name":"syUSD: fix OVault->Katana bridge leaf recipient (setManageRoot)",',
            '"description":"Repoint syUSD strategist+flashLoanAdapter manage root: depositAndSend sendParam.to now constrained to the boringVault (was the composer). Generated by CreateSyUsdMerkleRootSafe.s.sol"},"transactions":[',
            txs,
            "]}"
        );
    ...
    function _addLeafs(ManageLeaf[] memory leafs) internal {
        ...
        // high yield usdc lending cluster vault
