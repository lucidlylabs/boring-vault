...
contract CreateSyBTCCarryMerkleRootScript is Script, MerkleTreeHelper {
    using FixedPointMathLib for uint256;

    uint256 public privateKeyOwner;
    uint256 public privateKeyMorphoAgent;

    address public accountantAddress = 0x904752dBeA5c9a31581688770201b1a4FA8677Ee;
    address public boringVault = 0x3E0F237792715331067e98f1625b3D0aac2456f3;
    address public managerAddress = 0xA6B2F3f3f035DaBAba49b27123c594BB3c785ff9;
    address public rawDataDecoderAndSanitizer01 = 0x307803373Ac73Fb99077d363cdD4D26bf28b89ed;
    ...
    function _generateSyUsdMorphoAgentMerkleRoot() public {
        ...
        ERC20[] memory supplyTokens2 = new ERC20[](1);
        supplyTokens2[0] = getERC20(sourceChain, "WBTC");

        ERC20[] memory borrowTokens2 = new ERC20[](2);
        borrowTokens2[0] = getERC20(sourceChain, "USDC");
        borrowTokens2[1] = getERC20(sourceChain, "USDT");

        dexType = 3000; //T3 VAULT

        _addFluidDexLeafs(
            leafs, getAddress(sourceChain, "wBTC-DexUSDC-USDT"), dexType, supplyTokens2, borrowTokens2, false
        );
